...
public class TextChunkerTests
{
    ...
    {
        var chunks = TextChunker.GetChunks(" First paragraph.\r\n\r\nSecond paragraph.\n\n ");
    ...
    {
        var chunks = TextChunker.GetChunks("First sentence. Second sentence is longer.", 25, 0);
    ...
    public void Chunk_UnbrokenText_PreservesContentAndOverlap(int overlap)
    {
        ...
        var chunks = TextChunker.GetChunks(text, 10, overlap);
    ...
    {
        Assert.Empty(TextChunker.GetChunks(" \r\n\r\n \n\n"));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => TextChunker.GetChunks("text", maximum, overlap));
    }
}
